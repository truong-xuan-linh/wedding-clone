...
- **Audio toggle** — `#audio-control-wrapper` click plays/pauses the background music (hosted on `assets.linhtruong.me`)
...
- Background music: `https://assets.linhtruong.me/audio/...mp3`
- Template background images: `https://assets.linhtruong.me/templates/...`
- Uploaded photos (couple photos): `https://assets.linhtruong.me/uploads/...` or in `public/assets/`
- Custom fonts (Aquarelle, Carlytte, Signora, etc.): `https://assets.linhtruong.me/fonts/...`
