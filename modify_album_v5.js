...
const THRESHOLD = 7050; // shift lines below 7050
...
// Ensure the new images start AFTER the bounding box of the old images ends.
// Old images end around 7045. A spacing of 15px puts us at 7060.
// Backgrounds
newJSX += genBg(7060);
newJSX += genBg(7660);
newJSX += genBg(8260);

// Photos - exact mimics with safe Top offsets starting from 7060:
newJSX += genPhoto(7060, 9, 453, 300, newImages[0], "flip-in"); // full width
newJSX += genPhoto(7380, 9, 218, 218, newImages[1], "fade-in");
newJSX += genPhoto(7380, 238, 224, 337, newImages[2], "slide-down");
newJSX += genPhoto(7620, 9, 218, 328, newImages[3], "slide-up");
newJSX += genPhoto(7740, 237, 225, 294, newImages[4], "slide-left");
newJSX += genPhoto(7970, 9, 218, 218, newImages[5], "fade-in");
newJSX += genPhoto(8060, 237, 221, 284, newImages[6], "slide-up");
